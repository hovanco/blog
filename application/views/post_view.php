				...
				<div class="col-sm-4">
					<div class="card">
						<a href="<?= base_url() ?>./index.php/post_controller/detail_post/<?= $value['id'] ?>">
							<img class="card-img-top img-fluid" style="width: 400px; height: 200px; object-fit: cover;" src="<?= $value['image'] ?>" alt="Card image cap" /></a>
						<div class="card-block">
							<h5 style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis" class="card-title title">
								<?= $value['title'] ?></h5>
							<p style="display:-webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp:7; overflow:hidden; text-overflow: ellipsis;" class="card-text content"><?= $value['content'] ?></p>
							<p class="card-text edit">
								<small><a href="<?= base_url() ?>./index.php/post_controller/update_post/<?= $value['id'] ?>" class="btn btn-warning btn-xs">Update <i class="fa fa-pencil"></i></a>
								</small>
								<small><a href="<?= base_url() ?>./index.php/post_controller/delete_post/<?= $value['id'] ?>" class="btn btn-outline-danger btn-xs">Delete <i class="fa fa-remove"></i></a>
								</small>
								<small><a href="<?= base_url() ?>./index.php/post_controller/detail_post/<?= $value['id'] ?>" class="btn btn-outline-success btn-xs">Details </a>
								</small>
							</p>
						</div>
					</div>
