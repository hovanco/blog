...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/news_header.css'); ?>">
  </link>
...
<body>
    ...
    <section class="more-news">
      <div class="news-section">
        <!-- latest news -->
        <div class="world">
          <a href="<?= base_url() ?>./index.php/news_controller/newsDetails/<?= $post[0]['id'] ?>">
            <img class="main-image" src="<?= $post[0]['image'] ?>">
          </a>
          <a class="title-post-main"
            href="<?= base_url() ?>./index.php/news_controller/newsDetails/<?= $post[0]['id'] ?>"
            ><?= $post[0]['title'] ?></a>
        </div>

        <!-- The next 3 news -->
        <div class="second-world">
          <?php foreach ($post as $key => $main) :
            if ($key < 1 || $key >= 4) {
              continue;
            } ?>
          <div class="list-item">
            ...
            <a 
              ...
              class="title-post-child"><?= $main['title'] ?>
						</a>
          </div>
          <?php endforeach ?>
        </div>
        <hr style="margin-top: 14px;" />
          ...
          <div class="world__list-item">
            ...
            <a 
              href="<?= base_url() ?>./index.php/news_controller/newsDetails/<?= $main['id'] ?>"
              class="list-item__title"><?= $main['title'] ?>
						</a>
          </div>
					<hr/>
          <?php endforeach ?>
      ...
      <!-- The next 7 news -->
      <div class="news-red-popular">
        <?php foreach ($post as $key => $second) :
